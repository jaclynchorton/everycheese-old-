...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL", 
        default="postgres://jaclynhorton:IAmEnough64!@localhost:5432/everycheese"
    )
}
...
LOCAL_APPS = [
    ...
    # Your stuff: custom apps go here #custom users app
...
ADMINS = [("Jaclyn C. Horton", "jaclynchorton@icloud.com")]
